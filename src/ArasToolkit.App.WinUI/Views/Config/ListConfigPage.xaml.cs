...
/// <summary>
/// List配置页（WinUI 3）— 模板下载/文件导入/进度/历史表格。
/// </summary>
public sealed partial class ListConfigPage : Page
{
    public ListConfigPage()
    {
        this.InitializeComponent();
        DataContext = App.Services.GetRequiredService<ListConfigViewModel>();
    }
    ...
    {
        if (sender is Button { Tag: ListImportLog record })
