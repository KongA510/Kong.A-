...
/// <summary>
/// 生命周期配置页（WinUI 3）— 模板下载/文件导入/进度/历史表格。
/// </summary>
public sealed partial class LifecycleConfigPage : Page
{
    public LifecycleConfigPage()
    {
    ...
    {
        if (sender is Button { Tag: LifecycleImportLog record })
