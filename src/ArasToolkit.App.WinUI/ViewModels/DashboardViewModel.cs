...
public class DashboardViewModel : ObservableObject
{
    ...
    public ObservableCollection<QuickAction> AllFeatures { get; } = new()
    {
        ...
        new() { Name = "JSON比对", Description = "按结构归一化并比对 JSON 内容", Icon = "\uE8AB" },
        new() { Name = "JSON转实体类", Description = "生成 .NET 实体类与序列化映射", Icon = "\uE7BA" },
        new() { Name = "实体类转JSON", Description = "从 .NET 实体类生成 JSON 样例", Icon = "\uE713" },
