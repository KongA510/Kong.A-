...
public class TextTranslationViewModel : ObservableObject
{
        ...
        IFileDialogService fileDialogService)
    {
        ...
        BrowseSourceCommand = new RelayCommand(async _ => await BrowseSourceFileAsync());
    ...
    {
        var filePath = await _fileDialogService.PickOpenFileAsync("选择翻译源文件", ".xlsx", ".xls");
        if (filePath != null)
        {
    ...
    private void CopySourceText()
    {
        ...
        try
        {
            ...
            data.SetText(SourceTextPreview);
    ...
    {
        var defaultName = SelectedTemplateType == "Aras翻译" ? "Aras翻译模板.xlsx" : "自定义翻译模板.xlsx";
        var filePath = await _fileDialogService.PickSaveFileAsync(defaultName, ".xlsx");
