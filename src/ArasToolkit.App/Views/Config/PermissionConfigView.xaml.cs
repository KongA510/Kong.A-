...
/// <summary>
/// PermissionConfigView.xaml 的交互逻辑
/// </summary>
public partial class PermissionConfigView : UserControl
{
    public PermissionConfigView()
    {
        ...
        {
            Debug.WriteLine($"[PermissionConfigView] 初始化失败: {ex.Message}");
            throw;
        }
    }
    ...
    {
        if (sender is Button btn && btn.Tag is PermissionImportLog record)
        {
            try
            {
