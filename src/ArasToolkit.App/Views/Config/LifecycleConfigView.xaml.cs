...
/// <summary>
/// LifecycleConfigView.xaml 的交互逻辑
/// </summary>
public partial class LifecycleConfigView : UserControl
{
    public LifecycleConfigView()
    {
        try
        {
            InitializeComponent();
        ...
        {
            Debug.WriteLine($"[LifecycleConfigView] 初始化失败: {ex.Message}");
            throw;
        }
    }
    ...
    {
        if (sender is Button btn && btn.Tag is LifecycleImportLog record)
        {
            try
            {
