...
/// <summary>
/// 属性配置导入日志实体 — 映射 property_import_log 表
/// 敏感操作：记录每次属性配置批量导入的详细信息
/// </summary>
[Table("property_import_log")]
public class PropertyImportLog
{
    ...
    [NotMapped]
    public string Summary => $"属性配置 {Sheet1Count} 条";
}
